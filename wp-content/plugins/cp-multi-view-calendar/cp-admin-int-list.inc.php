...
{       
    ...
    if ($_GET["chs"] != '')
    {
        ...
        $tables = array($wpdb->prefix.'dc_mv_events', $wpdb->prefix.'dc_mv_calendars' );
...
<script type="text/javascript">
 ...
 function cp_updateConfig()
 {
    ...
    {        
        ...
        document.location = 'admin.php?page=<?php echo $this->menu_parameter; ?>_manage&chs='+chs+'&scr='+scr+'&r='+Math.random();
    }    
 } 
...
<?php } ?>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside"> 
   ...
   {       
          document.location = 'admin.php?page=<?php echo $this->menu_parameter; ?>_manage&edit=1&cal=1&item='+id+'&r='+Math.random();
   }
  </script>
  <div id="metabox_basic_settings" class="postbox" >
